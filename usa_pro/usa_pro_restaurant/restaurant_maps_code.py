...
def write_output(data):
    with open('restaurant_maps_data.csv', mode='a', encoding="utf-8", newline="") as output_file:
...
def fetch_data():
    ...
    for data1 in open("for_restaurant_city_country_data.csv",'r',encoding='utf-8'):
        restaurant_area = "restaurants+in" + str(data1.split(",")[0].replace(" ","+").replace('"',"+"))
        print("++++++++++",restaurant_area,"++++++++++")
        for item in [restaurant_area]:
            k = item
