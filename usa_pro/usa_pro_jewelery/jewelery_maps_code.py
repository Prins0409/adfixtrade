...
def write_output(data):
    with open('jewelery_maps_data.csv', mode='a', encoding="utf-8", newline="") as output_file:
...
def fetch_data():
    ...
    for data1 in open("for_jewelery_city_country_data.csv",'r',encoding='utf-8'):
        jewelery_area = "jewelerys+in" + str(data1.split(",")[0].replace(" ","+").replace('"',"+"))
        print("++++++++++",jewelery_area,"++++++++++")
        for item in [jewelery_area]:
            k = item
