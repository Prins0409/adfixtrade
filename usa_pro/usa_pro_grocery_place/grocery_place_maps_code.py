...
def write_output(data):
    with open('grocery_place_maps_data.csv', mode='a', encoding="utf-8", newline="") as output_file:
...
def fetch_data():
    ...
    for data1 in open("for_grocery_place_city_country_data.csv",'r',encoding='utf-8'):
        grocery_place_area = "grocerys+in" + str(data1.split(",")[0].replace(" ","+").replace('"',"+"))
        print("++++++++++",grocery_place_area,"++++++++++")
        for item in [grocery_place_area]:
            k = item
