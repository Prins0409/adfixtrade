...
def write_output(data):
    with open('heena_maps_data.csv', mode='a', encoding="utf-8", newline="") as output_file:
...
def fetch_data():
    ...
    for data1 in open("for_heena_city_country_data.csv",'r',encoding='utf-8'):
        heena_area = "heenas+in" + str(data1.split(",")[0].replace(" ","+").replace('"',"+"))
        print("++++++++++",heena_area,"++++++++++")
        for item in [heena_area]:
            k = item
