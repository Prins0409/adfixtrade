...
def write_output(data):
    with open('salon_maps_data.csv', mode='a', encoding="utf-8", newline="") as output_file:
...
def fetch_data():
    ...
    for data1 in open("for_salon_city_country_data.csv",'r',encoding='utf-8'):
        salon_area = "salons+in" + str(data1.split(",")[0].replace(" ","+").replace('"',"+"))
        print("++++++++++",salon_area,"++++++++++")
        for item in [salon_area]:
            k = item
